...
| Office Pack selection (trading desk, computer screen, keyboard, mouse, desk light, chair, desk phone, coffee mug, filing cabinet, coat rack, trash bin, paper stacks, printer, water cooler) | User-supplied local `Office Pack-glb` directory | **License/provenance not included with the supplied folder; verify before public distribution** | Unknown | Local user asset | `apps/client/public/assets/office/*.glb` |
| Trading-desk terminal screen (green monochrome fake market-data CRT display) | Generated for this project (Python/Pillow script, not a downloaded asset) — a "not a modern trading UI" 1980s terminal look, shared as one static texture across all 16 desks rather than a live per-desk canvas | N/A — original work, no attribution needed | — | — | `apps/client/public/assets/textures/terminal_screen.png` |
| "TRADING PLAN" desk paper sheet (Discipline/Risk Management/Position Size/Don't Tilt bullets + hand-drawn-style price chart) | Generated for this project (Python/Pillow script, not a downloaded asset) | N/A — original work, no attribution needed | — | — | `apps/client/public/assets/textures/trading_plan.png` |
